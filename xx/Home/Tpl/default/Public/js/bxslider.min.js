    ...
    t.fn.bxSlider = function (n) {
        ...
        var a = t(window).width(), l = t(window).height(), d = function () {
            ...
            r.wrap('<div class="bx-wrapper"><div class="bx-viewport" style="position: "relative"></div><div style="\n' +
                ...
                'text-align: center'+
                '    ">\n' +
                '    <a style="color: #ffffff"><h1>7*24小时对接</h1><h1>半小时响应</h1><h1>5日内给出方案</h1><h1>高效低价</h1><a style="width: 200px;height: 50px;background: red;color: #ffffff;padding-top: 6px;display: inline-block;border-radius:20px;font-size: 28px" href="www.baidu,com" >快速对接需求</></a >\n' +
