...
!function (t) {
    ...
    t.fn.bxSlider = function (n) {
        ...
        var a = t(window).width(), l = t(window).height(), d = function () {
            ...
            r.wrap('<div class="bx-wrapper"><div class="bx-viewport" style="position: "relative"></div><div style="\n' +
                '    width: 400px;\n' +
                '    height: 350px;\n' +
                ...
                'text-align: center'+
                '    ">\n' +
                '    <a style="color: #ffffff"><h1>7*24小时对接</h1><h1>半小时响应</h1><h1>5日内给出方案</h1><h1>高效低价</h1><a style="width: 200px;height: 50px;background: red;color: #ffffff;padding-top: 6px;display: inline-block;border-radius:20px;font-size: 28px" href="index.php/demand/index/g/c.html" >快速对接需求</></a >\n' +
                '</div></div>'), o.viewport = r.parent(), o.loader = t('<div class="bx-loading" />'), o.viewport.prepend(o.loader), r.css({
