           ...
           <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
                ...
                <div class="list_box">
                  <h2 class="left_h"><?php echo ($articlelist["ename"]); ?></h2>
                    ...
                    <div class="contents">
                        <h1 class="contents_title"><?php echo ($article["ename"]); ?></h1>
                        <p class="download_btn"><a href="__ROOT__/?m=common&a=down&id=<?php echo ($article["id"]); ?>" class="btn btn-primary page-btn" role="button" target="_blank"><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> &nbsp;DOWNLOAD </a></p> 
                ...
                <div class="list_related"> 
                    ...
                    <ul class="list_news related_news">
                      <?php if(is_array($related)): $i = 0; $__LIST__ = array_slice($related,0,5,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo W('Href',array('url'=>$vo['url'],'id'=>$vo['id'],'type'=>'Download','lang'=>'e'));?>" title="<?php echo ($vo["etitle"]); ?>"><?php echo (mb_substr($vo["etitle"],0,60,'utf-8')); ?></a><span class="news_time"><?php echo (date('Y-m-d',$vo["time"])); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>        
                    </ul>
                </div>
